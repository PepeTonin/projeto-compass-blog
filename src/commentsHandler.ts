...
function addCommentInPage(user: string, body: string) {
...
const commentContainer = document.querySelector(".comments")! as HTMLElement;
...
const inpNewCommentText = document.getElementById(
  "newCommentText"
)! as HTMLInputElement;
const inpNewCommentName = document.getElementById(
  "newCommentName"
)! as HTMLInputElement;
const btnNewComment = document.getElementById(
  "newCommentBtn"
